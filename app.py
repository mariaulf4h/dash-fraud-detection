...
fig_fraud_product = px.bar(fraud, x='ProductCategory', y='FraudResult',
             ...
             height=400)
fig_fraud_product.update_layout(xaxis={'visible': False, 'showticklabels': True})
fig_fraud_product.update_layout(yaxis={'visible': False, 'showticklabels': True})
...
fig_fraud_days = px.bar(fraud.sort_values("weekday"), x='days', y='FraudResult',
             hover_data=['ProductId', 'ChannelId'], color='Value',
             height=400)
fig_fraud_days.update_layout(xaxis={'visible': False, 'showticklabels': True})
fig_fraud_days.update_layout(yaxis={'visible': False, 'showticklabels': True})
...
fig_fraud_hour = px.bar(fraud.sort_values("hour"), x="hour", y='FraudResult',
             hover_data=['ProductId', 'ChannelId'], color='Value',
             height=400)
fig_fraud_hour.update_layout(xaxis={'visible': False, 'showticklabels': True})
fig_fraud_hour.update_layout(yaxis={'visible': False, 'showticklabels': True})
