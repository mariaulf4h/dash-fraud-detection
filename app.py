...
fig_fraud_product = px.bar(fraud, x='ProductCategory', y='FraudResult',
             ...
             height=400, labels = None)#{'FraudResult' : "Count of fraud. Transactions", 'ProductCategory': "Product Category"})
...
fig_fraud_days = px.bar(fraud.sort_values("weekday"), x='days', y='FraudResult',
             hover_data=['ProductId', 'ChannelId'], color='Value',
             height=400, labels = None)#{'FraudResult' : "Count of fraud. Transactions", 'days': "Weekday"})
...
fig_fraud_hour = px.bar(fraud.sort_values("hour"), x="hour", y='FraudResult',
             hover_data=['ProductId', 'ChannelId'], color='Value',
             height=400, labels = None)#{'FraudResult' : "Count of fraud. Transactions", 'hour': "Hour"})
